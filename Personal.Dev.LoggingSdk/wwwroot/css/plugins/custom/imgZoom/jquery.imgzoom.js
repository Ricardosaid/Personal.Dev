...
(function(window, $) {
    ...
    ImgZoom.prototype = {
        ...
        _createZoomDiv: function() {
            ...
            $(this.$zoomDiv).addClass("col-lg-5");
            $(this.$zoomDiv).addClass("col-md-5");
            $(this.$zoomDiv).addClass("col-sm-5");
            $(this.$zoomDiv).addClass("col-5");
        ...
        _createMask: function() {
            ...
            $('.contenedorZoom').empty();
            $('.contenedorZoom').append(this.$mask);
        },
        createHTML: function() {
            this._createZoomDiv();
            this._createMask();
